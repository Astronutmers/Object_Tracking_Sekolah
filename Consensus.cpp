        ...
        Point2f & center, vector<Point2f> & points_inlier, vector<int> & classes_inlier)
{
    ...
    outfile1.open("/home/ipung/Downloads/sekolah_asli/file/forarduino1.txt", ios::out | ios::app);
    outfile2.open("/home/ipung/Downloads/sekolah_asli/file/forarduino2.txt", ios::out | ios::app);

    //it's a subject for change, depend on the motor cabling configuration.
