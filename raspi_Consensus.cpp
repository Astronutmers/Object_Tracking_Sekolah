        ...
        Point2f & center, vector<Point2f> & points_inlier, vector<int> & classes_inlier)
{
    ...
    center.y /= points_inlier.size();
            ...
            outfile1.open("/home/ipung/Desktop/CppMT-master/file/forarduino1.txt", ios::out | ios::app);

            //cout << center.x << " + " <<  center.y << " || ";
            //masukin program gerak ke sini
	...
	incre++;
    /**else {
            outfile2.open("/home/ipung/Downloads/CppMT-master/file/forarduino2.txt", ios::out | ios::app);
